    ...
    for m in meta:
        ...
        with open(arguments.out, 'a') as f:
            f.write(
                "{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(
                    min(trace_closeness),
                    np.average(trace_closeness),
                    np.median(trace_closeness),
                    np.max(trace_closeness),
                    min(sh_closeness),
                    np.average(sh_closeness),
                    np.median(sh_closeness),
                    np.max(sh_closeness), trace_max, graph_max, sh_max,
                    stretch, len(trace)))
